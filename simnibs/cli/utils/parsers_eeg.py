...
write_format_eeg = CommandLineParser(
    "format",
    dict(
        metavar="format",
...
write_format_mne = CommandLineParser(
    "mne",
    dict(
...
write_format_fieldtrip = CommandLineParser(
    "fieldtrip",
    dict(
...
read_format_eeg = CommandLineParser(
    "format",
    dict(
        metavar="format",
...
read_format_mne = CommandLineParser(
    "mne",
    dict(
...
read_format_fieldtrip = CommandLineParser(
    "fieldtrip",
    dict(
