...
def parseArguments(argv):
    parser = argparse.ArgumentParser(
        prog="nifti2msh",
        description="Interpolate field in "
    ...
    parser.add_argument(
        "--type",
        default="elements",
        choices=["elements", "nodes"],
        help="Whether to store field in mesh elements or nodes. Default: elements",
    )
