...
class TestElectrode:
    def test_electrode_array_pair(self):
        ...
        electrode_array_pair.center = np.array(
            [
                [-20, 20],
                [0, 20],
                [20, 20],
        ...
        electrode_array_pair.update_geometry(
            center=None, radius=radius, length_x=length_x, length_y=length_y
        )
    ...
    def test_mixed_array(self):
        ...
        electrode_array_mixed = ElectrodeArray(
            channel_id=np.arange(center.shape[0]),
            center=center,
            radius=radius,
            length_x=length_x,
            length_y=length_y,
    ...
    def test_ElectrodeInitializer_array_pair(self, tmp_path):
        ...
        electrode_i.dirichlet_correction_detailed = (
        ...
        electrode_loaded = ElectrodeArrayPair(
    ...
    def test_ElectrodeInitializer_circular_array_geo_opt(self, tmp_path):
        ...
        electrode_i.distance_bounds = [
            10,
            20,
        ]  # distance bounds between inner and outer electrodes
