...
def octave_call(script):
    if sys.platform == "win32":
        octave_exe = glob.glob(
            os.path.join(r"C:\Octave\Octave-*\mingw64\bin\octave-cli.exe")
        )
        if len(octave_exe) == 0:
...
def replace_show_surface():
    fn_orig = os.path.abspath(
        os.path.join(
            os.path.dirname(__file__), "..", "..", "matlab_tools", "mesh_show_surface.m"
        )
    )
    fn_tmp = fn_orig + ".bk"
...
class TestMatlabErnie:
    def run_script(self, script_folder, script_name, clean=None):
        if clean is not None and os.path.exists(clean):
            shutil.rmtree(clean)
        shutil.copy(os.path.join(EXAMPLES_DIR, script_folder, script_name), script_name)
    ...
    def test_tms_optimize_ADM(self, example_dataset, replace_gmsh):
        os.chdir(example_dataset)
        ret = self.run_script(
            "optimization", "tms_optimization_adm.m", "tms_optimization_adm"
        )
        assert ret.returncode == 0
    ...
    def test_tms_flex_fig8coil_emag(self, example_dataset, replace_gmsh):
        os.chdir(example_dataset)
        ret = self.run_script(
            "tms_flex_optimization", "tms_flex_fig8coil_emag.m", "tms_optimization"
        )
        assert ret.returncode == 0
    ...
    def test_tms_flex_roundcoil_distance(self, example_dataset, replace_gmsh):
        os.chdir(example_dataset)
        ret = self.run_script(
            "tms_flex_optimization", "tms_flex_roundcoil_distance.m", "tms_optimization"
        )
        assert ret.returncode == 0
    ...
    def test_tms_flex_Brainsway_H1_distance(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tms_flex_optimization",
            "tms_flex_Brainsway_H1_distance.m",
            "tms_optimization_H1",
        )
        assert ret.returncode == 0
    ...
    def test_tms_flex_MagVenture_MST_emag(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tms_flex_optimization",
            "tms_flex_MagVenture_MST_emag.m",
            "tms_optimization_MSTemag",
        )
        assert ret.returncode == 0
...
class TestMatlabTESflexoptimize:
    ...
    def test_tes_flex_tes_Enormal_intensity(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_tes_Enormal_intensity.m",
            "tes_optimize_tes_Enormal_intensity",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_tes_focality(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_tes_focality.m",
            "tes_optimize_tes_focality",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_tes_intensity(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_tes_intensity.m",
            "tes_optimize_tes_intensity",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_ti_focality(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_ti_focality.m",
            "tes_optimize_ti_focality",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_ti_intensity(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_ti_intensity.m",
            "tes_optimize_ti_intensity",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_ttf_intensity(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_ttf_intensity.m",
            "tes_optimize_ttf_intensity",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_ttf_focality(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_ttf_focality.m",
            "tes_optimize_ttf_focality",
        )
        assert ret.returncode == 0
    ...
    def test_tes_flex_tes_geo_opt_intensity(self, example_dataset, replace_gmsh):
        ...
        ret = self.run_script(
            "tes_flex_optimization",
            "tes_flex_tes_geo_opt_intensity.m",
            "tes_optimize_tes_geo_opt_intensity",
        )
        assert ret.returncode == 0
