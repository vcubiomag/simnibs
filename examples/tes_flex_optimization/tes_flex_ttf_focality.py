...
electrode_layout = opt.add_electrode_layout(
    "ElectrodeArrayPair"
)  # Pair of TES electrode arrays
electrode_layout.center = [
    [-33, 22],
    [0, 22],
    [33, 22],  # electrode center(s) in reference electrode space (x-y plane)
    [-33, 0],
    [0, 0],
    [33, 0],
    [-33, -22],
...
electrode_layout.current = [
    ...
    1.0 / 9,
    1.0 / 9,
    1.0 / 9,  # electrode currents: 1/9 for each electrode of the first array
    -1.0 / 9,
    -1.0 / 9,
    -1.0 / 9,
    -1.0 / 9,
    ...
    -1.0 / 9,
    -1.0 / 9,
]  # -1/9 for each electrode of the second array
...
non_roi.roi_sphere_operator = [
    "difference"
]  # take difference between brain volume and the sphere region
