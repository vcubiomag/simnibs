...
def kvlWarpMesh(
    sourceMeshCollectionFileName, sourceDeformation, targetMeshCollectionFileName
):
    #
    ...
    if targetNumberOfNodes == sourceNumberOfNodes:
        if False:
            ...
            return (
                sourceReferencePosition + sourceDeformation - targetReferencePosition,
                0.0,
                0.0,
            )
