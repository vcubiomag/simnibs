...
matsimnibs = simnibs.mni2subject_coilpos(
    matsimnibs_MNI, "m2m_ernie", coil_skin_distance
)
...
# -------------------------------------------------------------------
center_MNI = [-45.8, -19.1, 84.0]  # corresponds to the 4th column of matsimnibs_MNI
